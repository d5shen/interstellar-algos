...
@Service()
export class AlgoExecution {
    protected readonly log = Log.getLogger(AlgoExecution.name)
            ...
            for (let amm of this.openAmms) {
                ...
                if (ammConfig) {
                    ...
                    let ammProps = new AmmProperties(
                        ammPair, quoteAssetAddress, AmmUtils.getAmmPrice(ammState),
                        ammState.baseAssetReserve, ammState.quoteAssetReserve
                    )
